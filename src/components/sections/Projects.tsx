            ...
            <div className="flex items-center gap-2 shrink-0">
              {project.github && (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-border hover:bg-muted/10 transition-colors"
                      ...
                      <ul className="space-y-1">
                        {project.challenges.map((c, j) => (
                          <li
                            ...
                            className="text-sm text-muted-foreground pl-4 relative"
                          >
                            <span className="absolute left-0 top-2 h-1 w-1 rounded-full bg-red-500" />
                            {c}
                          </li>
                        ))}
                      </ul>
